...
class _FakeShiftRepository implements ShiftRepository {
  ...
  /// `cashLinesOf` DIHAPUS pada M15.3 bersama Blind Closing — klien tidak lagi
  /// punya alasan membaca transaksi untuk menghitung kas ([11 §M15.3]).
  ...
  group('ShiftCubit (P-04)', () {
    blocTest<ShiftCubit, ShiftState>(
      ...
      act: (ShiftCubit c) => c.openShift(
        ...
        // Gerbang butir 10 sudah lolos sebelum layar memanggil ini
        // ([11 §M15.1]); nilainya diteruskan apa adanya ke baris shift.
        masterDataVersion: 7,
        deviceId: 'device-uji',
      ),
      expect: () => <Matcher>[
